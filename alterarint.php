                        	...
                        	<td id="corpoTop" colspan="3"></td>
                              ...
                              <tr>
                                <td width="5" bgcolor="#FFFFFF"></td>                              
									...
									<tr><td id="textoCabTabCorpo" colspan="9">Alterar Internamento de <?php echo $unome ?> </td></tr>
									<tr><td colspan="9"><div class="adicReg" align="left"><a href="internamentos.php">Voltar</a></div></td></tr>
									<form id="formRegUt" name="formRegUt" method="post" action="alterarintConf.php">        
                                            <tr>
                                            ...
                                            <tr>
                                              <td class="tabFormEsq">Medico responsavel:</td>
                                              <td>
                                            ...
                                            <tr>
                                              <td>&nbsp;</td>
                                              <td><input type="submit" name="alter" id="alter" value="Alterar" class="tabFormDir" /></td>
                                            </tr>
                                            <tr bgcolor="#CCCCCC">
                                              <td class="tabFormEsq"><div class="msgErro"<b>Nota:</b></div></td>			
                                              <td colspan="2" class="msgErro">&nbsp;&nbsp; Apenas pode alterar as observações</td>
                                            </tr>                                            
                                        </form>
