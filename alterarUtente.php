            ...
            <table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td height="68" id="textoCabTab">
					...
					$codUt_tmp=$_GET['codEditar'];//Guarda o código de utilizador na variável $codUtil_tmp que vem por URL				
                                    ...
                                    <td bgcolor="#FFFFFF" align="center">
                                        <table width="600" border="0" cellspacing="1" cellpadding="1" align="center">
                                            ...
                                            ><tr>
                                              ...
                                              <td width="300">
                                              <input type="text" name="nome" id="nome" class="tabFormDir" value="<?php echo $nome; ?>" /></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                              <input type="text" name="numCartUt" id="numCartUt" class="tabFormDir"  value="<?php echo $numCart; ?>" /></td>
                                            </tr>  
                                            <tr>
                                            ...
                                            <tr>
                                              ...
                                              <td><textarea name="morada" cols="40" rows="10" class="tabFormDir" id="morada"> <?php echo $morada; ?> </textarea></td>
                                            </tr>
											<tr>
                                              <td class="tabFormEsq">Contactos:</td>
                                              <td><textarea name="contacto" id="contacto" cols="40" rows="10" class="tabFormDir"><?php echo $contacto; ?></textarea></td>
                                            </tr>                                              
                                            <tr>
                                              <td class="tabFormEsq">Observações:</td>
                                              <td><textarea name="obs" cols="40" rows="10" class="tabFormDir" id="obs"><?php echo $obs; ?></textarea>	
                                              </td>
                                            </tr>
                                            <tr>
                                              <td>&nbsp;</td>
