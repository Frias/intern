        ...
        <td colspan="3" id="bodyCab">
            <table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
				...
				$codUtil_tmp=$_GET['codElim'];//Guarda o código de utilizador na variável $codUtil_tmp que vem por URL				
                                ...
                                <td width="5" bgcolor="#FFFFFF"></td>                              
                                    <td bgcolor="#FFFFFF" align="center">
                                        <table width="800" border="0" cellspacing="1" cellpadding="1" align="center">
                                            ...
                                            <form id="formElim" name="formElim" method="post" action="eliminarUtilConf.php">        
                                            <tr>
                                            ...
                                            <tr>
                                              ...
                                              <td width="300">
                                              <input type="text" name="nome" id="nome" class="tabFormDir" value='<?php echo $nomeU?>' readonly="readonly"/></td>
                                            </tr>
                                            <tr>
                                              <td class="tabFormEsq">Nome de Utilizador:</td>
                                              <td>
                                              <input type="text" name="user" id="user" class="tabFormDir" value='<?php echo $userU?>' readonly="readonly"/></td>
                                            </tr>
                                            <tr>
                                              <td class="tabFormEsq">Palavra passe:</td>
                                              <td>
                                              <input type="password" name="pass" id="pass" class="tabFormDir" readonly="readonly"/></td>
                                            </tr>
                                            <tr>
                                              <td class="tabFormEsq">Confirmar palavra passe:</td>
                                              <td>
                                              <input type="password" name="confPass" id="confPass" class="tabFormDir" readonly="readonly" /></td>
                                            </tr>
											<tr>
                                              <td class="tabFormEsq">Email:</td>
                                              <td>
                                              <input type="text" name="email" id="email" class="tabFormDir" value='<?php echo $emailU?>' readonly="readonly"/></td>
                                            </tr>                                              
                                            <tr>
                                              <td class="tabFormEsq">Tipo de utilizador:</td>
                                              <td>
												<input type="text" name="tipoUtil" id="tipoUtil" class="tabFormDir" value='<?php echo $tipoU?>' readonly="readonly"/>
                                              </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              <td>&nbsp;</td>
                                              <td><input type="submit" name="eliminar" id="eliminar" value="Eliminar" class="tabFormDir" />
                                              </td>
                                            </tr>
                                            <tr bgcolor="#CCCCCC">
