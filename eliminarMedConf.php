...
if(!isset($_SESSION['name'])){ //Informa se a variável não foi iniciada
	header("location:index.php"); // redireciona para a página index.php no caso de login errado
}
...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
                            ...
                            <td width="5" bgcolor="#FFFFFF"></td>                              
                                <td bgcolor="#FFFFFF" align="center">
									<table width="600" border="0" cellspacing="1" cellpadding="1" align="center">
                                        <tr><td id="textoCabTabCorpo" colspan="9">Eliminar Dados de Médico</td></tr>
	...
	$sql="DELETE FROM t_medicos WHERE codMed = '".$cod_tmp."'";
	$resultado=mysqli_query($cn, $sql); //Faz a alteração na BD
	$num_afect=mysqli_affected_rows($cn);
	if ($resultado) {
			header("location:medicos.php"); //Se a variável $resultado tiver dados, significa que alterou e redireciona para a página indexLogin.php
	}
