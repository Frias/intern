                              ...
                              <tr>
                                <td width="5" bgcolor="#FFFFFF"></td>
                                    <td bgcolor="#FFFFFF" align="center">
									     <?php
									$codUtil_tmp=$_GET['codutil'];
									if ($codUtil_tmp == NULL) {//verifica a existencia da variavel, neste caso a não existencia
									echo "<br>** Especifique um Utilizador **<br>";
									}
									else{//no caso da variavel não ser nula
									$sql="select * from t_utilizador where codUtil = $codUtil_tmp";//cria a query
									$verPerfUtil = mysqli_query ($cn,$sql);//guarda a tabela retribuida
									$count = mysqli_num_rows($verPerfUtil);//conta as linhas da tabela retribuida que será sempre ou 0 ou 1
									if ($count == 0) {//no caso da tabela estar vazia o utilizador não existe
									echo "<br>** Utilizador inexistente **<br>";
									}
									else {//no caso de não ser 0 (ser 1) guarda o valor de cada coluna e imprime a tabela
										while ($dad=mysqli_fetch_assoc($verPerfUtil)) {
											$nomeU=$dad["nomeCompUtil"];
											$userU=$dad["user"];	
											$emailU=$dad["email"];
											$tipoU=$dad["tipoUtil"];	
											$dataRegU=$dad["dataRegUtil"];	
											}
									...
									<tr>
									<td class="cabTabperfUtil1" width="180">Nome de Utilizador</td>
									<td class="cabTabperfUtil2"><?php echo $userU ?></td>
									</tr>
									<tr>
									<td class="cabTabperfUtil1" width="180">Data de registo</td>
									<td class="cabTabperfUtil2"><?php echo $dataRegU ?></td>
									</tr>
									<tr>
									<td class="cabTabperfUtil1" width="180">Tipo de Utilizador</td>
									<td class="cabTabperfUtil2"><?php echo $tipoU ?></td>
									</tr>
									<tr>
									<td class="cabTabperfUtil1" width="180">E-mail</td>
									<td class="cabTabperfUtil2"><?php echo $emailU ?></td>
									</tr>
									<tr><td colspan="9"><div class="adicReg" align="right"><a href="alterarUtil.php?codUEditar=<?php echo $codUtil_tmp ?>">Alterar</a></div></td></tr>
