        ...
        <td colspan="3" id="bodyCab">
            <table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
				...
				$codUtil_tmp=$_GET['codUEditar'];//Guarda o código de utilizador na variável $codUtil_tmp que vem por URL				
				$sql="SELECT * FROM t_utilizador WHERE codUtil=$codUtil_tmp"; //variável com comando SQL que selecciona todos os dados do utilizador a ser alterado
				...
				if ($verResEdit) { //verifica se a variável tem conteúdo
					while ($regEdit=mysqli_fetch_assoc($verResEdit)) { //Imprime o conteúdo do array
						$codU=$regEdit["codUtil"];
				      	$nomeU=$regEdit["nomeCompUtil"];
				      	$userU=$regEdit["user"];
				      	$passU=$regEdit["pass"];	
				      	$emailU=$regEdit["email"];						
				      	$tipoU=$regEdit["tipoUtil"];	
				      	$dataRegU=$regEdit["dataRegUtil"];	
						}
					}
                                ...
                                <td width="5" bgcolor="#FFFFFF"></td>                              
                                    <td bgcolor="#FFFFFF" align="center">
                                        <table width="800" border="0" cellspacing="1" cellpadding="1" align="center">
                                            ...
                                            <tr>
                                              <td width="150" class="tabFormEsq">Código:</td>
                                              <td width="650">
                                              <input type="text" name="cod" id="nome" class="tabFormDir" value='<?php echo $codU?>' readonly="readonly"/></td>
                                            </tr>
                                            <tr>
                                              <td width="300" class="tabFormEsq">Nome Completo:</td>
                                              <td width="300">
                                              <input type="text" name="nome" id="nome" class="tabFormDir" value='<?php echo $nomeU?>'/></td>
                                            </tr>
                                            <tr>
                                              <td class="tabFormEsq">Nome de Utilizador:</td>
                                              <td>
                                              <input type="text" name="user" id="user" class="tabFormDir" value='<?php echo $userU?>'/></td>
                                            </tr>
                                            <tr>
											...
											<tr>
                                              ...
                                              <td>
                                              <input type="text" name="email" id="email" class="tabFormDir" value='<?php echo $emailU?>'/></td>
                                            </tr>                                              
                                            <tr>
                                              ...
                                              <td>
												...
												<?php
													if ($tipoU=="Administrador"){ //Verifica qual o tipo de utilizador para saber qual deverá ficar selecionado
                                            ...
                                            <tr>
                                              <td align="right">Data de registo:</td>
                                              <td>
                                              <input type="text" name="dataReg" id="dataReg" value='<?php echo $dataRegU ?>' readonly="readonly"  class="tabFormDir" /></td>
                                            </tr>                                            
                                            <tr>
                                              <td>&nbsp;</td>
                                              <td><input type="submit" name="editar" id="editar" value="Editar" class="tabFormDir" />
                                              <input type="reset" name="limpar" id="limpar" value="Limpar" class="tabFormDir" />
                                              </td>
                                            </tr>
                                            <tr bgcolor="#CCCCCC">
